<template>
          <div class='tenement' v-if="dataErr">
                    <div class='tenementTop'>
                              ...
                              <div class='tenementTopText'>
                                        ...
                                        <div class='tenementTopLv2'>
                                                  <p>{{tenement_data.tenement_plan ? tenement_data.tenement_plan : '0' }}
                                                            <span class="￥_￥">元</span>
                                                  </p>
                                                  <p>物业费</p>
                                        </div>
...
export default {
          ...
          methods: {
                    ...
                    get_http() {
                              let url = 'buidingProperty/' + this.$route.params.id;
                              let options = {
                                        urls: url,
                                        methods: 'get',
                                        data: {},
                              ...
                              this.$http(options).then(res => {
                                        if (res.response.status == 0) {
                                                  this.dataErr = true;
                                                  this.tenement_data = res.response.data;
                                                  return;
                                        }
