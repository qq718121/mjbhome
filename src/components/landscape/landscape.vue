<template>
     <div class='landscape' v-if="dataErr">
               ...
               <div class='landscapeTopText'>
                    ...
                    <div class='landscapeTopLv2'>
                         <p class="landscape_top_recommend">
                              {{landscapesData.landscape_top.recommend ? landscapesData.landscape_top.recommend + "%" : ''}}
                         </p>
                         <p>绿化率</p>
                    </div>
                    <div class="clear"></div>
    ...
    landscapesData.landscape_top.landscape_rate.length!==0">
          ...
          <div class='landscapeHr'>
               ...
               <span>总体评价</span><img src='../../../static/gray.svg'>
               <i></i>
          </div>
          <div class='landscapeOverall' v-html="landscapesData.landscape_top.designText"></div>
          <div class='landscapeHr'>
               <i></i><img src='../../../static/gray.svg'>
               <span>主要功能区</span><img src='../../../static/gray.svg'>
               <i></i>
          </div>
          ...
          <div class='landscapeHr'>
               <i></i><img src='../../../static/gray.svg'>
               <span>本楼盘景观评测</span><img src='../../../static/gray.svg'>
               <i></i>
          </div>

          <div class='park' v-if="landscapesData.landscape_top.scenery_type.type_list &&
         landscapesData.landscape_top.scenery_type.type_list.length !==0">
               <div class='parkTop'>
                    <div class='parkTitle'>
                         <span><img :src='this.$url.icon_jgjb_Img'></span>
                         <span>小区景观效果评测</span>
                    </div>
                    <div class="parkIndex">
                         <i></i>
                         ...
                         <div class="type_list" v-for="item in landscapesData.landscape_top.scenery_type.type_list">
                              <p>
                                   <span>{{item.type}}</span>
                                   <span>{{$class_name_ftn.landscape(item.lv)}}</span>
                              </p>
                              <div v-if="item.text" class="type_text">
          ...
          <div class='park' v-if="landscapesData.landscape_top.scenery_type.quality_list &&
          ...
          <div v-if="landscapesData.previous_landscape_top.previous_housesName">
               <div class='otherTop'>
                    <div class='otherTopImg'>
                         <img :src='landscapesData.previous_landscape_top.previous_landscape_top_Img ?
            landscapesData.previous_landscape_top.previous_landscape_top_Img : this.$url.error_img' alt='图片无法显示'>
               ...
               <div v-if="landscapesData.previous_landscape_top.previous_landscape_rate &&
        landscapesData.previous_landscape_top.previous_landscape_rate.length !==0">
                    <div class='landscapeHr'>
                         <i></i><img src='../../../static/gray.svg'>
                         <span>同开发商往期楼盘景观评级</span><img src='../../../static/gray.svg'>
                         <i></i>
                    </div>
                    <div class='landscapeRate'>
               ...
               <div class='landscapeHr'>
                    <i></i><img src='../../../static/gray.svg'>
                    <span>同开发商往期楼盘景观评测</span><img src='../../../static/gray.svg'>
                    <i></i>
               </div>

               <div class='park' v-if="landscapesData.previous_landscape_top.previous_scenery_type.type_list &&
           landscapesData.previous_landscape_top.previous_scenery_type.type_list.length !== 0">
                    <div class='parkTop'>
                         ...
                         <div class="parkIndex">
                              <i></i>
                              <i></i>
                              <div class="type_list" v-for="item in landscapesData.previous_landscape_top.previous_scenery_type.type_list">
                                   <p>
                                        <span>{{item.type}}</span>
                                        <span>{{$class_name_ftn.landscape(item.lv)}}</span>
                                   </p>
               ...
               <div class='park' v-if="landscapesData.previous_landscape_top.previous_scenery_type.quality_list &&
           landscapesData.previous_landscape_top.previous_scenery_type.quality_list.length !== 0">
                    <div class='parkTop'>
                         ...
                         <div class="parkIndex">
                              <i></i>
                              <i></i>
                              <div class="type_list" v-for="item in landscapesData.previous_landscape_top.previous_scenery_type.quality_list">
                                   <p>
                                        <span>{{item.type}}</span>
                                        <span>{{$class_name_ftn.landscape(item.lv)}}</span>
                                   </p>
          ...
          <div class='landscapeHr' style="margin-bottom:0.9rem" v-if="landscapesData.other_city.length != 0">
               <i></i><img src='../../../static/gray.svg'>
               <span>
                    <p>同开发商其他城市</p>
                    <p>已入住楼盘景观展示</p>
          ...
          <div class="other_city" v-for="(val,index) in landscapesData.other_city" @click="other_path_handler(index,val)" v-if='val.img || val.title || val.city_name'>
...
export default {
     ...
     methods: {
          ...
          get_http() {
               let url = 'buidingScenery/' + this.$route.params.id;
               let options = {
                    urls: url,
                    methods: 'get',
                    data: {},
               ...
               this.$http(options).then(res => {
                    if (res.response.status == 0) {
                         ...
                         this.landscapesData = res.response.data;
                         if (!this.landscapesData.landscape_top) {
                              this.set_hint('无数据');
                              return;
                         }
                         this.dataErr = true;
