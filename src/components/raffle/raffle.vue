...
<style scoped>
  ...
  .m-raffle .g-tit .u-tit-img img, .u-houseExclusive-trophy-li .u-houseExclusive-trophy-li-img img {
    width: 100%;
  }
  ...
  .m-raffle .g-luckyPrize .u-g-luckyPrize-tit, .u-g-houseExclusive-tit {
    font-family: PingFangSC-Semibold;
    font-size: 0.5rem;
    color: #FFFFFF;
    letter-spacing: 0.02rem;
