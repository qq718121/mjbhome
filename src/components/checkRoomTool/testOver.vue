<template>
     <div class="testOver">
          <TitBar titBarTits="" :isOver="true" :isBackHome="isBackHome" :isList="this.$route.query.isList" v-on:shareHandlerBtn='shareHandlerBtn' />
          <Dislog :shows="dislogShow" v-on:shareHandlerBtn='shareHandlerBtn' />

          <div class="g-testOver-tit" style="background-image: url('http://oxrgdeqd8.bkt.clouddn.com/bg_yanfangjieguo_l@3x.png')" v-if="stageNum >=40">
          ...
          <div class="g-testOver-tit" style="background-image: url('http://oxrgdeqd8.bkt.clouddn.com/bg_yanfangjieguo_h@3x.png')" v-else>
               <div class="g-stage" v-if="isWater">
                    <WaterWave :stage="stageNum" />
               </div>
               <p class="g-stage-tex">恭喜您获得称号</p>
          ...
          <div class="g-testOver-over">
               <div class="g-testOver-head">
                    <span>验房项结果统计</span>
                    <span style="float:right;margin-right:0.3rem;font-size: 0.28rem;color: #0080FF;" @click="f_go_checkRoomOver" v-if="this.$route.query.share !=1">查看全部</span>
               </div>
